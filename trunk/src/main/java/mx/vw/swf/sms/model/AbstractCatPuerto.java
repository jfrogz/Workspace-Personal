...
/**
 * AbstractCatPuerto entity provides the base persistence definition of the CatPuerto entity. @author MyEclipse Persistence Tools
 */
@MappedSuperclass
public abstract class AbstractCatPuerto implements java.io.Serializable {

    // Fields
   private CatPuertoId id;

    // Constructors
   /**
    * default constructor
    */
   public AbstractCatPuerto() {
   }

   /**
    * full constructor
    */
   public AbstractCatPuerto(CatPuertoId id) {
      this.id = id;
   }
   ...
   @AttributeOverrides({
      ...
      @AttributeOverride(name = "activo",
              column = @Column(name = "activo",
                      precision = 3,
                      scale = 0))})
   public CatPuertoId getId() {
      return this.id;
   }

   public void setId(CatPuertoId id) {
      this.id = id;
   }
