...
/**
 * CatParametroId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class CatParametroId implements java.io.Serializable {
    ...
    * default constructor
    */
   public CatParametroId() {
   }

   /**
    * minimal constructor
    */
   public CatParametroId(Long id,
           Short idApp,
           Short idAdmin) {
      this.id = id;
      this.idApp = idApp;
   ...
   public boolean equals(Object other) {
      ...
      if (!(other instanceof CatParametroId)) {
         return false;
      }
      CatParametroId castOther = (CatParametroId) other;
