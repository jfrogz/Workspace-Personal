...
/**
 * CatPropEmpresaId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class CatPropEmpresaId implements java.io.Serializable {
    ...
    * default constructor
    */
   public CatPropEmpresaId() {
   }

   /**
    * minimal constructor
    */
   public CatPropEmpresaId(Long id,
           Short idApp,
           Short idAdmin) {
      this.id = id;
      this.idApp = idApp;
   ...
   public boolean equals(Object other) {
      ...
      if (!(other instanceof CatPropEmpresaId)) {
         return false;
      }
      CatPropEmpresaId castOther = (CatPropEmpresaId) other;
