...
import mx.vw.swf.sms.controller.MovimientosProveedoresController;
...
public class DataFXLauncher extends Application {
    ...
    public void start(Stage primaryStage) throws FlowException, VetoException {
        ...
        if (!dbOK) {
            ...
            //Flow flow = new Flow(MovimientosProveedoresController.class);
            Flow flow = new Flow(MovimientosClientesController.class);
