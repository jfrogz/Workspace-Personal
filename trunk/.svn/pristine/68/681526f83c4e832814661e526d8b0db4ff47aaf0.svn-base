...
public class CustomDestinationDataProvider
{
    ...
    void executeCalls(String destName) throws JCoException {
        ...
        JCoFunction function = dest.getRepository().getFunction("BAPI_USER_DISPLAY");
        if (null == function) {
            throw new RuntimeException("BAPI_USER_DISPLAY not found in SAP.");
        }
        try {
            function.getImportParameterList().setValue("USERNAME", "DZM152Z");
    ...
    static Properties getDestinationPropertiesFromUI()
    {
        ...
        connectProperties.setProperty(DestinationDataProvider.JCO_ASHOST, "10.148.83.76");
        ...
        connectProperties.setProperty(DestinationDataProvider.JCO_USER,   "DZM152Z");
        connectProperties.setProperty(DestinationDataProvider.JCO_PASSWD, "3FMkc,,40");
